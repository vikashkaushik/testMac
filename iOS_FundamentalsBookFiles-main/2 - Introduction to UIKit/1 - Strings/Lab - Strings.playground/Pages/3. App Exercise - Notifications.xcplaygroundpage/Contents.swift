...
let newBest = 15125
let congratulations = "Congratulations, " + fullName + "! You beat your previous daily high score of " + String(previousBest) + " steps by walking " + String(newBest) + " steps yesterday!"
