...
//print(falcon.weapon)
//This doesn't work because falcon does not have a property weapon because weapon is a property of the Fighter subclass, not Spaceship. It doesn't inherit it.
